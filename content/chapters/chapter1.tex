...
\begin{figure}[h]                                               % Anfang der Deklaration einer Abbildung
    \includegraphics[width=0.5\textwidth]{content/img/company.png}        % Einbinden der Grafik mit halber Breite des Textbereichs
    \caption{Firmenlogo}                                        % Bezeichnung der Abbildung
    \label{fig:firmenlogo}                                      % Interne Bezeichnung der Abbildung um aus dem Text darauf verweisen zu können
\end{figure}
